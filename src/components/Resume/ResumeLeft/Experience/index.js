	...
	return(
		<div className="flex flex-col relative">
			...
			</h2>
			{
				ExperienceData.map(
					( data,index ) => (
						<div key={index} className="relative my-5 before:left-2 before:top-4 before:-translate-x-2/4 before:-translate-y-2/4 before:h-4 before:w-4 before:bg-black before:rounded-full before:absolute after:top-4 after:-translate-x-2/4 after:-translate-y-2/4 after:left-2 after:h-3 after:w-3 after:bg-white after:rounded-full after:absolute">
							<div className="ml-10">
								{data.position}
							</div>
							<div className="ml-10">
